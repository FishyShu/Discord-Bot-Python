...
HELP_CATEGORIES: dict[str, list[tuple[str, str]]] = {
    "Music": [
        ...
        ("filter set", "Apply audio filter preset"),
        ("filter clear", "Remove audio filter"),
        ("crossfade", "Set fade-in/out per track"),
    ],
    "Voice Tools": [
    ...
    "AI": [
        ...
        ("ai config behaviour", "Configure mentions, reply style, typing indicator"),
        ("ai config webhook-set", "Set a webhook persona (custom name + avatar)"),
        ("ai config webhook-clear", "Remove the webhook persona"),
        ("ai config channel add", "Add an AI auto-response channel"),
        ("ai config channel remove", "Remove an AI auto-response channel"),
        ("ai config language", "Set the response language"),
        ("ai config tone", "Set the response tone"),
        ("ai config blocklist add", "Block a topic"),
        ("ai config blocklist remove", "Unblock a topic"),
        ("ai config blocklist list", "Show blocked topics"),
        ("ai config apikey", "Set a premium API key + model"),
        ("ai config thinking", "Toggle extended thinking mode"),
